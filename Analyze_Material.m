...
Figure(3);
loglog(F(1),Mats(1,2),'d','color','r','markerfacecolor','r','markersize',10,...
F(2),Mats(2,2),'d','color','g','markerfacecolor','g','markersize',10,...
F(3),Mats(3,2),'d','color','b','markerfacecolor','b','markersize',10,...
F(4),Mats(4,2),'d','color','c','markerfacecolor','c','markersize',10,...
F(5),Mats(5,2),'d','color','m','markerfacecolor','m','markersize',10,...
F(6),Mats(6,2),'d','color','y','markerfacecolor','y','markersize',10,...
F(7),Mats(7,2),'d','color','k','markerfacecolor','k','markersize',10);
